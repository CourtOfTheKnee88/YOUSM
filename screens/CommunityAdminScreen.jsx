        ...
        onPress: async () => {
          try {
            const res = await fetch(
              `${SERVER_URL}/communities/${communityId}/admins`,
              {
                method: "POST",
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              const res = await fetch(
                `${SERVER_URL}/communities/${communityId}/bans`,
                {
                  method: "POST",
                  headers: { "Content-Type": "application/json" },
                  body: JSON.stringify({
              ...
              Alert.alert(
                "Success",
                "Member is banned from posting for 10 minutes."
              );
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoLine}>• They are not app-wide admins.</Text>
          <Text style={styles.infoLine}>
